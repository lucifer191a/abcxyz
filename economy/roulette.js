module.exports = ({
   ...
   $setGlobalUserVar[cash;$sum[$getGlobalUserVar[cash];$replaceText[$replaceText[$checkCondition[$toLowercase[$message[2]]==$randomText[red;black]];true;$message[1]];false;-$message[1]]]
...
Được ăn cả, ngã vào lòng em...]
   ...
   Số dư còn lại: **$sum[$getGlobalUserVar[cash];$replaceText[$replaceText[$checkCondition[$toLowercase[$message[2]]==$randomText[red;black]];true;$message[1]];false;-$message[1]]]**💴.}]
   $addTimestamp
   $onlyIf[$getGlobalUserVar[cash]>=$message[1];{description:description:Không đủ tiền!}{color:RANDOM}]
